...
namespace MG
{
	...
	{
		Add_Comment("Generated by Magnet v" + std::string(MG_VERSION));
		Add_Newline();
		Add_Comment("Do not edit the following since any changes will be overwritten next time the project files are "
		            "regenerated.");
		Add_Comment("You can insert custom CMake code at the bottom of this file.");
		Add_Newline();
	}
